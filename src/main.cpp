...
void usage() {
  ...
  cerr << "\t-ionly\tOnly compute formula information. (see notes 2 and 3)\n";
  cerr << endl;
  cerr << "Additional options:\n";
  cerr << "\t-h\tDisplay usage mode.\n";
  cerr << "\t-syntax\tDisplay formula syntax.\n";
  cerr << endl;
  cerr << "Renaming algorithms (see note 4):\n";
  ...
  cerr << "\t3) If option -oinfo is set and the file exists, information\n";
  cerr << "\twill be appended.\n";
  cerr << "\t4) If option -a is not set or an invalid algorithm is passed,\n";
