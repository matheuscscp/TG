...
O primeiro resultado observado é apresentado na Tabela \ref{dag_x_tree_info}, relativo ao número de cláusulas produzido em cada combinação. As seguintes regras foram usadas para determinar quando cada representação foi melhor. Para uma fórmula fixa $\phi$, $C_i$ foi melhor que $C_{i+4}$ se, e somente se:
\begin{enumerate}
...
% DAG fez ficar mais rapido no pre e na busca
