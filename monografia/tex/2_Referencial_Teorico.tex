...
\begin{example}
    ...
    \[
    \begin{array}{lll}
            \neg(\phi_1 \leftrightarrow \phi_2) & \longmapsto \neg((\phi_1 \rightarrow \phi_2) \wedge (\phi_2 \rightarrow \phi_1)) & [T4, 5.a] \\
                 & \longmapsto \neg((\neg \phi_1 \vee \phi_2) \wedge (\neg \phi_2 \vee \phi_1)) & [T4, 4] \\
                 & \longmapsto \neg(\neg \phi_1 \vee \phi_2) \vee \neg(\neg \phi_2 \vee \phi_1) & [T4, DM] \\
                 & \longmapsto (\neg \neg \phi_1 \wedge \neg \phi_2) \vee (\neg \neg \phi_2 \wedge \neg \phi_1) & [T4, DM] \\
    ...
    \begin{array}{lll}
            \neg(\phi_1 \leftrightarrow \phi_2) & \longmapsto \neg((\phi_1 \wedge \phi_2) \vee (\neg \phi_1 \wedge \neg \phi_2)) & [T4, 5.b] \\
                 ...
                 & \longmapsto (\neg \phi_1 \vee \neg \phi_2) \wedge (\neg \neg \phi_1 \vee \neg \neg \phi_2) & [T4, DM]\\
                 & \longmapsto (\neg \phi_1 \vee \neg \phi_2) \wedge (\phi_1 \vee \phi_2) & [T4, 1]\\
    \end{array}
    \]
...
\tabela{Número de cláusulas de uma fórmula}{numerop}{ccc}{
	\hline
...
\tabela{Coeficientes $a$ e $b$ do Algoritmo \ref{boydelatour}}{tabela_a_b}{ccc}{
	\hline
